...
public class Player : MonoBehaviour
{
    ...
    void Start()
    {
		 ...
		 */
        		if (isPlayer1) 
                {
                    ...
                    catchInput = KeyCode.Joystick1Button0;
                    throwInput = KeyCode.Joystick1Button2;
                    dashInput = KeyCode.Joystick1Button5;
                    
                    /*catchInput = KeyCode.RightShift;
                    throwInput = KeyCode.LeftShift;
                    dashInput = KeyCode.Keypad0;*/
                ...
                else
                {
                    ...
                    catchInput = KeyCode.Joystick2Button0;
                    throwInput = KeyCode.Joystick2Button2;
                    dashInput = KeyCode.Joystick2Button5;
                    
                    /*catchInput = KeyCode.Tab;
                    throwInput = KeyCode.Z;
                    dashInput = KeyCode.R;*/
    ...
    void Update()
    {
        ...
        verticalMotion = 0.150f * planeOne.getMaxVelocity();
        horizontalMotion = 0.150f * planeOne.getMaxVelocity();
